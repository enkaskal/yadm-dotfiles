...
ENCRYPTION_PIPE = ['keybase', 'encrypt', 'enkaskal']
DECRYPTION_PIPE = ['keybase', 'decrypt']
...
registrations = {
    'google': {
        ...
        'client_id': '406964657835-aq8lmia8j95dhl1a2bvharmfk3t1hgqj.apps.googleusercontent.com', # 'borrowed' from thunderbird: https://github.com/mozilla/releases-comm-central/blob/master/mailnews/base/src/OAuth2Providers.sys.mjs#L156
